...
_MOCK_ALPHAFOLD_DATA = {
    ...
    "HIF1α": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-Q16665-F1-model_v6.pdb",
    ...
    "VEGF": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-P15692-F1-model_v6.pdb",
    ...
    "KRAS": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-P01116-F1-model_v6.pdb",
    ...
    "MET": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-P08581-F1-model_v6.pdb",
    ...
    "ALK": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-Q9UM73-F1-model_v6.pdb",
    ...
    "PD-L1": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-Q9NZQ7-F1-model_v6.pdb",
    ...
    "PD-1": {
        ...
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-Q15116-F1-model_v6.pdb",
    ...
    "ACE2": {
        ...
        "accession": "Q9BYF1",
        "gene": "ACE2",
        "mean_confidence": 90.7,
        "confidence_tier": "high",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-Q9BYF1-F1-model_v6.pdb",
    ...
    "SPIKE RBD": {
        ...
        "accession": "P0DTC2",
        "gene": "S",
        "mean_confidence": 67.1,
        "confidence_tier": "medium",
        "pdb_url": "https://alphafold.ebi.ac.uk/files/AF-0000000365840314-model_v1.pdb",
        "entry_id": "AF-0000000365840314",
...
async def lookup_alphafold(protein_name: str) -> Optional[dict]:
    ...
    try:
        async with httpx.AsyncClient(timeout=15.0) as client:
            ...
            af = af_data[0]
            # AlphaFold API v6 uses "globalMetricValue"; older versions used "confidenceAvgLocalScore"
            confidence = round(float(
                af.get("globalMetricValue") or af.get("confidenceAvgLocalScore") or 0
            ), 1)
